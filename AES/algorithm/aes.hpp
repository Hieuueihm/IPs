...
const unsigned char rConLUT[15] = {	
    0x00, // Rcon[0] 
    0x01, // Rcon[1]
    0x02, // Rcon[2]
    0x04, // Rcon[3]
...
const unsigned char inv_sbox[16][16] = {
    ...
    {0x17, 0x2b, 0x04, 0x7e, 0xba, 0x77, 0xd6, 0x26, 0xe1, 0x69, 0x14, 0x63,
     0x55, 0x21, 0x0c, 0x7d}};
static const unsigned char mixMatrix[4][4] = {
    {2, 3, 1, 1}, {1, 2, 3, 1}, {1, 1, 2, 3}, {3, 1, 1, 2}};


// 4 *(14 + 1) * 4
#define AES_MAX_ROUND_KEY_SIZE 240 
...
private:
		void keyExpansion();
		void rotWord(bytes b);
		void subWord(bytes b);
		void rCon(bytes b,int n);
		void xorWord(bytes a, bytes b, bytes c);
        void addRoundKey(int leftIndex, int rightIndex, bytes b, int roundIndex);
		void subBytes(bytes b);
		void shiftRows(bytes b);
		void mixColumns(bytes b);
