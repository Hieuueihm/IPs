module kem_core (
    ...
    subword u_sub_rot_w3 (.in(rot_w0), .out(sub_rot_w0));
    subword u_sub_rot_w7 (.in(rot_w4), .out(sub_rot_w4));
    subword u_sub_w3     (.in(w0),     .out(sub_w0));
    ...
    wire [31:0] temp = (!key_len)  ? g_w0      :  
                       (!step_sel) ? g_w4      :   
                                     sub_w0;      

    wire [31:0] nw0 = w3 ^ temp;
    wire [31:0] nw1 = w2 ^ nw0;
    wire [31:0] nw2 = w1 ^ nw1;
    wire [31:0] nw3 = w0 ^ nw2;

 
    wire [31:0] nw4 = w7 ^ temp;
    wire [31:0] nw5 = w6 ^ nw4;
    wire [31:0] nw6 = w5 ^ nw5;
    wire [31:0] nw7 = w4 ^ nw6;


    wire [127:0] rk_lower = {nw0, nw1, nw2, nw3};
    wire [127:0] rk_upper = {nw4, nw5, nw6, nw7};
    ...
    always @(posedge clk or negedge rst_n) begin
        if (!rst_n) begin
            ...
            rk_out   <= 128'h0;
            rk_valid <= 1'b0;
            buff     <= key_len ? key_in : {128'h0, key_in[127:0]};;
